    ...
    <div class="ml-auto flex items-center gap-2">
        ...
        <?php if ($is_admin): ?>
            <div class="admin-menu-wrapper" id="admin-menu-wrapper">
                <button class="admin-menu-toggle <?= $nav_current_page !== 'dashboard' ? 'admin-menu-toggle--active' : '' ?>" id="admin-menu-toggle" type="button" title="Menu navigasi admin" aria-label="Buka menu navigasi admin" aria-haspopup="true" aria-expanded="false" aria-controls="admin-menu-dropdown">
                    <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-gray-400"><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg>
                </button>
                <div class="admin-menu-dropdown" id="admin-menu-dropdown">
                    ...
                    <a href="<?= meel_base_url_path() ?>/admin/stats" class="admin-menu-item <?= $nav_current_page === 'stats' || $nav_current_page === 'content' ? 'active' : '' ?>">
                        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>
                        Media Analytics
                    </a>
                    <a href="<?= meel_base_url_path() ?>/admin/activity-log" class="admin-menu-item <?= $nav_current_page === 'activity_log' ? 'active' : '' ?>">
                        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg>
                        Activity Log
                    </a>
                    ...
                    <a href="<?= meel_base_url_path() ?>/admin/meelcoin" class="admin-menu-item <?= $nav_current_page === 'meelcoin' ? 'active' : '' ?>">
                        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M16 8h-6a2 2 0 1 0 0 4h4a2 2 0 1 1 0 4H8"></path><path d="M12 18V6"></path></svg>
                        MEeLCoin Settings
                    </a>
                    ...
                    <a href="<?= meel_base_url_path() ?>/admin/chat" class="admin-menu-item <?= $nav_current_page === 'chat' ? 'active' : '' ?>">
                        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>
                        Chat Admin
                    </a>
                    ...
                    <a href="<?= meel_base_url_path() ?>/admin/mfa-reset" class="admin-menu-item <?= $nav_current_page === 'mfa_reset' ? 'active' : '' ?>">
                        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>
                        MFA Management
                    </a>
...
<script>
(function(){
    if (typeof MEELTheme === 'undefined') return;
    MEELTheme.init({
        isLoggedIn: <?= isset($_SESSION['username']) ? 'true' : 'false' ?>,
        csrfToken: window.MEEL_CSRF || ''
    });
})();
</script>
