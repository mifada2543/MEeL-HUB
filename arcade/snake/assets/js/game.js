...
function draw() {
  ...
  snake.forEach((seg, index) => {
    ...
    if (isHead) {
      ...
      ctx.beginPath();
      ctx.arc(
        eyeX1 + (direction === "RIGHT" ? 1 : direction === "LEFT" ? -1 : 0),
        eyeY1 + (direction === "DOWN" ? 1 : direction === "UP" ? -1 : 0),
        1.2,
        0,
        Math.PI * 2,
      );
      ...
      ctx.beginPath();
      ctx.arc(
        eyeX2 + (direction === "RIGHT" ? 1 : direction === "LEFT" ? -1 : 0),
        eyeY2 + (direction === "DOWN" ? 1 : direction === "UP" ? -1 : 0),
        1.2,
        0,
        Math.PI * 2,
      );
