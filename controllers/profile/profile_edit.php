...
?>
    <link rel="stylesheet" href="<?= meel_base_url_path() ?>/assets/css/profile/edit.css?v=<?= @filemtime(__DIR__ . '/../../assets/css/profile/edit.css') ?>">
...
<body class="text-gray-300 p-6">
    ...
    <script src="../assets/js/profile/avatar-crop.js?v=<?= filemtime(__DIR__ . '/../../assets/js/profile/avatar-crop.js') ?>"></script>
</body>
