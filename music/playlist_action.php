...
/** Redirect helper — keeps every action to a one-liner */
...
if ($action === 'add_to_playlist') {
    ...
    // Gunakan prepared statement, bukan raw interpolation
...
if ($action === 'delete_playlist') {
    ...
    // WHERE clause menyertakan user_id — user hanya bisa hapus miliknya sendiri
